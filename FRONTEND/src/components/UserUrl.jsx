...
export default function UserUrl({ url, onDeleted }) {
  ...
  return (
    <div className="bg-white p-4 rounded-xl shadow-md flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 transition-transform hover:-translate-y-1 hover:shadow-lg">
      {/* URL Info */}
      ...
      <div className="flex gap-2 shrink-0">
        <button
          ...
          className="px-3 py-1 border border-gray-300 rounded-lg text-sm bg-gray-100 hover:bg-gray-200 cursor-pointer"
        >
          Copy
        </button>
        ...
        <button
          ...
          className="px-3 py-1 bg-red-100 text-red-700 border border-red-200 rounded-lg text-sm hover:bg-red-200 cursor-pointer"
        >
          Delete
        </button>
        ...
        <button
          ...
          className="px-3 py-1 bg-green-100 text-green-700 border border-green-200 rounded-lg text-sm hover:bg-green-200 cursor-pointer"
        >
